...
def main(argv=None):
    ...
    contact_reporter = builder.AddSystem(
        contact.ContactReporter(),
    )
    builder.Connect(
    ...
    while current_time < end_time:
        ...
        contact_context = contact_reporter.GetMyContextFromRoot(context)
        contact_reporter.Publish(contact_context)

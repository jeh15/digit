...
class WebSocketsNode:
    def __init__(self, freq=500, run_sim=True):
        ...
        self.set_pose = [
            "simulator-set-pose",
            {"model-id": 0, "pose": {"rpyxyzd": [0, 0, 0, 0, 0, 1.029]}},
        ]
        ...
        self.action_move_to = [
            "action-move",
            {"velocity": {"axy": [0.0, 0.25, 0.0]}, "mobility-parameters": {}},
        ]
        ...
        # Publishers
        self.start_llapi_pub = rospy.Publisher(
            "/websockets/llapi_enabled", Bool, queue_size=1
        )
